...
// @LINE:17
private[this] lazy val controllers_Application_create5_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("diagnoses/new"))))
...
// @LINE:18
private[this] lazy val controllers_Application_save6_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("diagnoses/now"))))
...
// @LINE:19
private[this] lazy val controllers_Application_upload7_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("diagnoses"))))
...
// @LINE:22
private[this] lazy val controllers_Application_edit8_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("diagnoses/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_Application_edit8_invoker = createInvoker(
...
// @LINE:23
private[this] lazy val controllers_Application_update9_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("diagnoses/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_Application_update9_invoker = createInvoker(
...
// @LINE:26
private[this] lazy val controllers_Application_delete10_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("diagnoses/"),DynamicPart("id", """[^/]+""",true),StaticPart("/delete"))))
private[this] lazy val controllers_Application_delete10_invoker = createInvoker(
...
case controllers_Application_save6_route(params) => {
   call { 
        controllers_Application_save6_invoker.call(controllers.Application.save())
   }
}
...
case controllers_Application_upload7_route(params) => {
   call { 
        controllers_Application_upload7_invoker.call(controllers.Application.upload())
   }
}
        

// @LINE:22
case controllers_Application_edit8_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_Application_edit8_invoker.call(controllers.Application.edit(id))
   }
}
        

// @LINE:23
case controllers_Application_update9_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_Application_update9_invoker.call(controllers.Application.update(id))
   }
}
        

// @LINE:26
case controllers_Application_delete10_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_Application_delete10_invoker.call(controllers.Application.delete(id))
   }
}
