...
/**/
object editForm extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template2[Long,Form[Computer],play.twirl.api.HtmlFormat.Appendable] {
...
"""),_display_(/*7.2*/main/*7.6*/ {_display_(Seq[Any](format.raw/*7.8*/("""
    ...
    """),_display_(/*11.6*/form(routes.Application.update(id))/*11.41*/ {_display_(Seq[Any](format.raw/*11.43*/("""
        ...
        """),format.raw/*13.9*/("""<fieldset>
            ...
            """),_display_(/*15.14*/inputText(computerForm("name"), '_label -> "Computer name", '_help -> "")),format.raw/*15.87*/("""
            """),_display_(/*16.14*/inputDate(computerForm("introduced"), '_label -> "Introduced date", '_help -> "")),format.raw/*16.95*/("""
            """),_display_(/*17.14*/inputDate(computerForm("discontinued"), '_label -> "Discontinued date", '_help -> "")),format.raw/*17.99*/("""
...
"""))}
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  HASH: ce5ce964bbc97e6437de45a87f37110b5b33c63d
